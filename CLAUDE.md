...
**Describes v0.70.0, 2026-07-28.** `package.json`'s `version` is the single source of truth for the app version — if it's moved on since this date, treat anything below with more skepticism the further it's fallen behind (check `CHANGELOG.md` for what shipped after this doc's version).
