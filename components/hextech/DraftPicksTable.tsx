  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-3 px-3.5 py-3.5">
        ...
        <div className="flex items-center gap-2">
          ...
          <ThemedSelect
            ...
            triggerClassName="min-w-[92px] rounded-[6px] px-2 py-1.5 text-[10px]"
          />
        </div>
      </div>
      ...
      <div className="border-t border-txt/[0.06] px-3.5 py-3 text-center">
        <button type="button" onClick={onShowAll} disabled={showAll || rows.length <= 10} className="text-[10.5px] font-medium text-accent-300 transition-colors duration-[120ms] ease-in hover:text-accent-200 disabled:cursor-default disabled:text-txt/[0.36] focus-visible:outline-2 focus-visible:outline-accent focus-visible:outline-offset-2">
